...
distribution = pkg_resources.require('xbob.ap')[0]
...
latex_documents = [
  ('index', 'xbob_ap.tex', u'Bob Audio Processing Routines',
...
man_pages = [
    ('index', 'xbob_ap', u'Bob Audio Processing Documentation', [u'Idiap Research Institute'], 1)
]
